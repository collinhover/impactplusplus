    ...
    .defines(function () {
        ...
        ig.UIToggle = ig.global.UIToggle = ig.UIInteractive.extend(/**@lends ig.UIToggle.prototype */{
            ...
            activate: function (entity) {
                ...
                this.currentAnim = this.anims[ this.getDirectionalAnimName( this.animNameActivate ) ];
            ...
            deactivate: function (entity) {
                ...
                this.currentAnim = this.anims[ this.getDirectionalAnimName( this.animNameDeactivate ) ];
