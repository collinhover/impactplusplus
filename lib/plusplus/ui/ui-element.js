        ...
        ig.UIElement = ig.global.UIElement = ig.EntityExtended.extend(/**@lends ig.UIElement.prototype */{
                    ...
                    if (this.linkedTo) {
                        ...
                        if ( this.linkAlign.x !== 0 ) {
                            ...
                            if ( this.linkAlign.x < 0 ) {
                                ...
                                this.pos.x += this.linkAlign.x * this.boundsDraw.width * this.scaleMod;

                            }
                            else {

                                this.pos.x += this.linkAlign.x * this.linkedTo.boundsDraw.width * this.linkedTo.scaleMod;
                        ...
                        if ( this.linkAlign.y !== 0 ) {
                            ...
                            if ( this.linkAlign.y < 0 ) {
                                ...
                                this.pos.y += this.linkAlign.y * this.boundsDraw.height * this.scaleMod;

                            }
                            else {

                                this.pos.y += this.linkAlign.y * this.linkedTo.boundsDraw.height * this.linkedTo.scaleMod;
            ...
            getBounds: function () {
                ...
                if ( this.angle !== 0 ) {
                    ...
                    if ( this.bounds === this.boundsBase ) {
                    ...
                    this.boundsBase = this.getBoundsDraw();

                    this.angle = angle;

                    this.bounds = this.getBoundsDraw();

                }
                else {

                    this.bounds = this.boundsBase = this.getBoundsDraw();
            ...
            getTotalPosX: function () {
                ...
                pos -= this.align.x * this.totalSizeX * this.scaleMod;
            ...
            getTotalPosY: function () {
                ...
                pos -= this.align.y * this.totalSizeY * this.scaleMod;
