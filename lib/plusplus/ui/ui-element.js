ig.module(
    ...
    .defines(function () {
        ...
        ig.UIElement = ig.global.UIElement = ig.EntityExtended.extend(/**@lends ig.UIElement.prototype */{
            ...
            reposition: function ( force ) {
                ...
                if (!this.getIsMovingSelf()) {
                    ...
                    if (this.linkedTo) {
                        ...
                        this.pos.x = this.linkedTo.posDraw.x;
                        this.pos.y = this.linkedTo.posDraw.y;

                        if ( this.linkAlign.x !== 0 ) {

                            if ( this.linkAlign.x < 0 ) {

                                this.pos.x += this.linkAlign.x * this.sizeDraw.x * this.scaleMod;

                            }
                            else {

                                this.pos.x += this.linkAlign.x * this.linkedTo.sizeDraw.x * this.linkedTo.scaleMod;
                        ...
                        if ( this.linkAlign.y !== 0 ) {
                            ...
                            if ( this.linkAlign.y < 0 ) {
                                ...
                                this.pos.y += this.linkAlign.y * this.sizeDraw.y * this.scaleMod;

                            }
                            else {

                                this.pos.y += this.linkAlign.y * this.linkedTo.sizeDraw.y * this.linkedTo.scaleMod;
            ...
            /**
             * Gets draw position accounting for margin and alignment.
             * @override
             **/
            getPosDrawX: function () {
                ...
                pos -= this.align.x * this.sizeDraw.x * this.scaleMod;
            ...
            getPosDrawY: function () {
                ...
                pos -= this.align.y * this.sizeDraw.y * this.scaleMod;
