        ...
        ig.UITextBubble = ig.global.UITextBubble = ig.UIOverlay.extend(/**@lends ig.UITextBubble.prototype */{
            ...
            resize: function ( force ) {
                ...
                if ( this.message ) {
                    ...
                    var messageSizeX = this.message.sizeDraw.x * scaleMod;
                    ...
                    if ( messageSizeX > sizeX ) {
                        ...
                        messageSizeX = this.message.sizeDraw.x * scaleMod;

                    }

                    var messageSizeY = this.message.sizeDraw.y * scaleMod;
                    ...
                    if ( messageSizeY > sizeY ) {
                        ...
                        this.message.refresh( true );
                        messageSizeY = this.message.sizeDraw.y * scaleMod;
            ...
            refill: function () {
                ...
                if ( this.fill && this.triangleLength > 0 ) {
                    ...
                    var height = this.sizeDraw.y - this.triangleLength;
