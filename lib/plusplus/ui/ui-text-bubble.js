ig.module(
    ...
    .defines(function () {
        ...
        ig.UITextBubble = ig.global.UITextBubble = ig.UIOverlay.extend(/**@lends ig.UITextBubble.prototype */{
             ...
             */
            size: {x: _c.TEXT_BUBBLE.SIZE_X, y: _c.TEXT_BUBBLE.SIZE_Y},
             ...
             */
            sizePct: {x: _c.TEXT_BUBBLE.SIZE_PCT_X, y: _c.TEXT_BUBBLE.SIZE_PCT_Y},
             ...
             */
            padding: {x: _c.TEXT_BUBBLE.PADDING_X, y: _c.TEXT_BUBBLE.PADDING_Y},
            ...
            resetExtras: function () {
                ...
                if ( this.textSettings ) {
                    ...
                    this.textSettings.margin = {x: 0, y: this.padding.y - this.triangleLength};
                    this.textSettings.marginAsPct = false;

                }

                this.textMoveToSettings = ig.merge( this.textMoveToSettings, {
                    offset: {x: 0, y: this.padding.y - this.triangleLength}
                });
                ...
                if ( !this.sizeAsPct ) {
                    ...
                    this.resetState.size = this.resetState.size || { x: 0, y: 0 };
                ...
                if ( this.message ) {
                    ...
                    this.message.autoRefreshText = false;
            ...
            recordResetState: function () {
                ...
                this.resetState.sizePct = this.resetState.sizePct || { x: 0, y: 0 };
