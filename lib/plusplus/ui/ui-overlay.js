        ...
        ig.UIOverlay = ig.global.UIOverlay = ig.UIElement.extend(/**@lends ig.UIOverlay.prototype */{
            ...
            refill: function ( width, height ) {
                ...
                if ( this.fill ) {
                    ...
                    if ( this.pixelPerfect ) {
                        ...
                        this.fill.setDimensions(this.boundsDraw.width * this.scale, this.boundsDraw.height * this.scale);
                ...
                if ( !this.pixelPerfect ) {
                    ...
                    // fill with gradient
                        ...
                        if (this.gradientRadial) {
                            ...
                            fillStyle = _utc.radialGradient(this.cover ? Math.max(this.boundsDraw.width, this.boundsDraw.height) : Math.min(this.boundsDraw.width, this.boundsDraw.height), this.fillColors);
                            ...
                            if (this.gradientHorizontal) {
                                ...
                                fillStyle = _utc.linearGradient(0, 0, this.boundsDraw.width, 0, this.fillColors);

                            }
                            else {

                                fillStyle = _utc.linearGradient(0, 0, 0, this.boundsDraw.height, this.fillColors);
            ...
            ready: function () {
                ...
                if ( this.message ) {
                    ...
                    ig.game.spawnEntity( this.message, 0, 0 );
