ig.module(
    ...
    .defines(function () {
        ...
        ig.UIOverlay = ig.global.UIOverlay = ig.UIElement.extend(/**@lends ig.UIOverlay.prototype */{
            ...
            /**
             * Called just after entity added to game world and creates text if needed.
             * @override
             **/
            ready: function () {
                ...
                if (this.textSettings) {
                    ...
                    this.text = ig.game.spawnEntity(this.text || ig.UIText, 0, 0, this.textSettings);
            ...
            cleanup: function () {
                ...
                if (this.text) {
                    ...
                    ig.game.removeEntity(this.text);
