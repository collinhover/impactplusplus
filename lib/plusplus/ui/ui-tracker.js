    ...
    .defines(function () {
        ...
        ig.UITracker = ig.global.UITracker = ig.UIInteractive.extend(/**@lends ig.UITracker.prototype */{
            ...
            initProperties: function () {
                ...
                this.autoTrackingTimer = new ig.Timer();
            ...
            track: function (show, entity) {
                ...
                // get by type
                if (!this.entityTracking && this.entityClass) {

                    this.entityTracking = ig.game.getEntitiesByClass(this.entityClass, {
                        from : { x: x, y: y },
                        first: !show
                    })[ 0 ];
                ...
                if (this.entityTracking) {
                    ...
                    this.animOverride( this.getDirectionalAnimName( "tracking" ), { lock: true } );
                    ...
                    if (show !== false) {
                        ...
                        var diffX = this.entityTracking.pos.x + this.entityTracking.size.x * 0.5 - x;
                        var diffY = this.entityTracking.pos.y + this.entityTracking.size.y * 0.5 - y;
                        ...
                        var offsetX = normalX * ( this.entityDirectionIndicator.sizeDraw.x * 0.5 + ( entity ? entity.size.x * 0.5 : 0 ) );
                        var offsetY = normalY * ( this.entityDirectionIndicator.sizeDraw.y * 0.5 + ( entity ? entity.size.y * 0.5 : 0 ) );

                        this.entityDirectionIndicator.pos.x = x + offsetX - this.entityDirectionIndicator.sizeDraw.x * 0.5;
                        this.entityDirectionIndicator.pos.y = y + offsetY - this.entityDirectionIndicator.sizeDraw.y * 0.5;
            ...
            untrack: function () {
                ...
                this.animRelease( this.getDirectionalAnimName( "tracking" ) );
            ...
            unpause: function () {
                ...
                this.autoTrackingTimer.unpause();
