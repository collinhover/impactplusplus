ig.module(
    ...
    .defines(function () {
        ...
        ig.UITracker = ig.global.UITracker = ig.UIInteractive.extend(/**@lends ig.UITracker.prototype */{
            ...
            /**
             * Trackers should activate on init.
             * @override
             */
            activated: true,
             ...
             */
            directionThresholdX: _c.ENTITY.SIZE_EFFECTIVE_X,
             ...
             */
            directionThresholdY: _c.ENTITY.SIZE_EFFECTIVE_Y,
             ...
             * @param {Boolean} [show=false] whether to show tracking direction.
            ...
            track: function (show, entity) {
                ...
                // get by type
                    ...
                    // only find first as we only want to know if one of type exists, not which is closest
                    else {

                        this.entityTracking = ig.game.getEntitiesByType(this.entityClass, { first: true })[ 0 ];
                ...
                if (this.entityTracking) {
                    ...
                    // retrack when tracking is removed

                    this.entityTracking.onRemoved.add(this.track, this);

                    this.currentAnim = this.anims.tracking;

                    // show direction

                    if (show === true && entity && !entity._killed) {
                        ...
                        var diffX = this.entityTracking.bounds.minX + this.entityTracking.bounds.width * 0.5 - centerX;
                        var diffY = this.entityTracking.bounds.minY + this.entityTracking.bounds.height * 0.5 - centerY;
                        ...
                        var offsetX = normalX * ( this.entityDirectionIndicator.totalSizeX * 0.5 + entity.bounds.width * 0.5 );
                        var offsetY = normalY * ( this.entityDirectionIndicator.totalSizeY * 0.5 + entity.bounds.height * 0.5 );

                        this.entityDirectionIndicator.pos.x = centerX + offsetX - this.entityDirectionIndicator.totalSizeX * 0.5;
                        this.entityDirectionIndicator.pos.y = centerY + offsetY - this.entityDirectionIndicator.totalSizeY * 0.5;
            ...
            untrack: function () {
                ...
                if (this.entityTracking) {
                    ...
                    this.entityTracking.onRemoved.remove(this.track, this);
