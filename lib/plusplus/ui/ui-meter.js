    ...
    .defines(function () {
        ...
        ig.UIMeter = ig.global.UIMeter = ig.UIElement.extend(/**@lends ig.UIMeter.prototype */{
            ...
            getTotalSizeX: function () {
                ...
                if ( this.bar && !this.vertical ) {

                    size += this.barTotalWidth;

                    if ( this.animSheet || this.animSheetPath ) {

                        size += this.barAnimSpacing;
                    ...
                    if (this.bar) {
                        ...
                        // default draw
                            ...
                            if (this.borderWidth > 0) {
                                ...
                                this.border.draw(
                                    this.boundsDraw.minX + extraX - ig.game.screen.x,
                                    this.boundsDraw.minY + extraY - ig.game.screen.y,
                                    undefined, undefined, undefined, undefined,
                                    this.scale
                                );
                            ...
                            if (this.value < 1 && this.backgroundStyle) {
                                ...
                                this.background.draw(
                                    this.boundsDraw.minX + offsetSizeX + extraX - ig.game.screen.x,
                                    this.boundsDraw.minY + offsetSizeY + extraY - ig.game.screen.y,
                                    srcOriginX, srcOriginY,
                                    invValueSizeX,
                                    invValueSizeY,
                                    this.scale
