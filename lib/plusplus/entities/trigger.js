    ...
    .defines(function () {
        ...
        ig.EntityTrigger = ig.global.EntityTrigger = ig.EntityExtended.extend(/**@lends ig.EntityTrigger.prototype */{
            ...
            check: function (entity) {
                ...
                if (this.triggerable && ( !this.once || !this.activated ) && this.waitTimer.delta() >= 0 && !this.paused ) {
             ...
             * @param {Boolean} [unactivated=false] whether this trigger should not activate itself.
             **/
            ...
            /**
             * Handles activating all targets in the target sequence.
             * <span class="alert alert-info"><strong>Tip:</strong> override this method to change how each target is triggered.</span>
             * @param {ig.EntityExtended} entity entity calling trigger.
             */
            handleTargets: function (entity) {
                ...
                for ( var i = 0, il = this.targetSequence.length; i < il; i++ ) {
                    ...
                    this.targetSequence[i].activate( entity );
