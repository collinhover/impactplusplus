    ...
    .defines(function () {
        ...
        ig.EntityConversation = ig.global.EntityConversation = ig.EntityTrigger.extend(/**@lends ig.EntityConversation.prototype */{
            ...
            setup: function () {
                ...
                this.stepsUnused.length = this.stepsUsed.length = this.participating.length = 0;
            ...
            _addUnusedStep: function ( step ) {
                ...
                if ( speaker && !this._speakersModified[ name ] ) {
                    ...
                    if ( this.interrupting && speaker.conversation !== this && speaker.conversation instanceof ig.EntityConversation && speaker.conversation.activated ) {

                        speaker.conversation.deactivate();
            ...
            nextStep: function () {
                ...
                if ( this.stepsUnused.length > 0 ) {
                    ...
                    if ( this.cameraFollows && this._cameraWasFollowing ) {
            ...
            activateStep: function () {
                ...
                if ( this._step ) {
                    ...
                    if ( this.speaker && this.messageFollowsSpeaker ) {
                        ...
                        if ( ( this.pausing || this.locking|| this.lockingPlayer || this.step.locking ) && this.cameraFollows && !messageContainer.fixed ) {
            ...
            hideStep: function () {
                ...
                if ( this.cameraFollows ) {
                    ...
                    if ( ig.game.camera && ig.game.camera.entity === this._cameraFollowing ) {
                    ...
                    this._cameraFollowing = undefined;
            ...
            update: function () {
                ...
                if ( this.step ) {
                    ...
                    // auto advance
                    else if ( this.autoAdvance && this.advanceTimer.delta() >= 0 ) {
