            ...
            _addUnusedStep: function ( step ) {
                ...
                if ( this.pausing ) {
                    ...
                    if ( speaker ) {
                        ...
                        speaker.animOverride( 'listen', { loop: true } );
                    ...
                    if ( this.pausing ) {
                        ...
                        for ( var name in this.steps ) {
                            ...
                            if ( speaker ) {
                                ...
                                if ( ( speaker.anims.talk && speaker.overridingAnim === speaker.anims.talk )
                                    || ( speaker.anims.listen && speaker.overridingAnim === speaker.anims.listen ) ) {
                ...
                if ( this.stepsUnused.length > 0 ) {
                    ...
                    if ( this._step.name ) {
                        ...
                        if ( this.speaker ) {
                            ...
                            this.speaker.animOverride( 'talk', { loop: true } );
            ...
            showStep: function () {
                ...
                if ( this._step ) {
                    ...
                    if ( this.speaker && this.messageFollowsSpeaker ) {
                        ...
                        messageSettings = ig.merge( {
                            layerName: this.speaker.layerName,
                            fixed: false
            ...
            hideStep: function () {
                ...
                if ( this.speaker ) {
                    ...
                    if ( this.activated ) {
                        ...
                        this.speaker.animOverride( 'listen', { loop: true } );
                        ...
                        if ( ( this.speaker.anims.talk && this.speaker.overridingAnim === this.speaker.anims.talk )
                            || ( this.speaker.anims.listen && this.speaker.overridingAnim === this.speaker.anims.listen ) ) {
