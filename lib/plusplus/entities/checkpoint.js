ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityCheckpoint = ig.global.EntityCheckpoint = ig.Spawner.extend(/**@lends ig.EntityCheckpoint.prototype */{
             ...
             * @default
             */
            spawnAtSide: _c.TOP_DOWN ? null : { x: 0, y:  1 },
            ...
            /**
             * Checkpoint can force camera to return to it before spawning next, using {@link ig.EntityCheckpoint#showSpawn}.
             * @override
             */
            spawnNext: function ( entity ) {
                ...
                if ( !camera || !this.showSpawn || ( camera.entity === this && !camera.transitioning ) ) {
                    ...
                    // transition camera to checkpoint and then do spawn

                    camera.onTransitioned.addOnce( this.activate, this);
                    camera.follow(this);
            ...
            spawned: function (entity) {
				...
				// reset spawned count
				// so we can respawn as many times as needed
