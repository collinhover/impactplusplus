ig.module(
    ...
    .defines(function () {
         ...
         * @class
         * @extends ig.EntityAbilityExecute
         * @memberof ig
         * @author Collin Hover - collinhover.com
         **/
        ig.EntityAbilityUpgrade = ig.global.EntityAbilityUpgrade = ig.EntityAbilityExecute.extend(/**@lends ig.EntityAbilityUpgrade.prototype */{
