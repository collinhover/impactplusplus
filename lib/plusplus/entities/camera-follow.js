ig.module(
    ...
    .defines(function () {
         ...
         */
        ig.EntityCameraFollow = ig.global.EntityCameraFollow = ig.EntityTrigger.extend({
            ...
            initProperties: function () {
                ...
                this.followDelayTimer = new ig.TimerExtended( 0, this );
            ...
            complete: function () {
                ...
                if ( this._followed && this.targetsToFollow.length === 0 ) {
            ...
            followNext: function ( withoutDelay ) {
                ...
                if ( !withoutDelay && !this._followDelaying && this.followDelay ) {
                    ...
                    if ( this.targetsToFollow.length > 0 ) {
