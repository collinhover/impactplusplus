ig.module(
        'plusplus.entities.ability-execute'
    )
    .requires(
    ...
    .defines(function () {
        ...
        /**
         * Trigger that executes an ability in targets.
         * @class
         * @extends ig.EntityTrigger
         * @memberof ig
         * @author Collin Hover - collinhover.com
         **/
        ig.EntityAbilityExecute = ig.global.EntityAbilityExecute = ig.EntityTrigger.extend(/**@lends ig.EntityAbilityExecute.prototype */{
