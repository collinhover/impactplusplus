    ...
    ig.global.EntityLight = ig.EntityLight = ig.EntityExtended.extend({
        ...
        **/
		...
		recordChanges: function ( force ) {
			...
			if ( !_um.almostEqual( this.radiusDelta, 0, _s.zeroPrecision )
				|| !_um.almostEqual( this.alphaDelta, 0, _s.zeroPrecision ) ) {
			...
			if ( this.dynamicColor ) {
				...
				if ( ( !_um.almostEqual( this.rDelta, 0, _s.zeroPrecision )
					|| !_um.almostEqual( this.gDelta, 0, _s.zeroPrecision )
					|| !_um.almostEqual( this.bDelta, 0, _s.zeroPrecision ) ) ) {
