ig.module(
    ...
    .defines(function () {
         ...
         * light.performance = ig.CONFIG.MOVABLE;
         * // however, if our dummy is not static
         * dummy.performance = ig.CONFIG.DYNAMIC;
        ...
        ig.EntityLight = ig.global.EntityLight = ig.EntityExtended.extend(/**@lends ig.EntityLight.prototype */{
            ...
            getBounds: function () {
                ...
                bounds.maxX = this.pos.x + diameter;
                bounds.maxY = this.pos.y + diameter;
            ...
            getBoundsDraw: function () {
                ...
                bounds.minX = minX;
                bounds.minY = minY;
                bounds.maxX = minX + diameter;
                bounds.maxY = minY + diameter;
                bounds.width = diameter;
                bounds.height = diameter;
            ...
            compute: function () {
                ...
                if (this.castsShadows && ( this.performance === _c.MOVABLE || this._changedAdd )) {
                ...
                for (var i = 0, il = ig.game.layers.length; i < il; i++) {
                    ...
                    if (layer.numEntities) {
                        ...
                        for (var j = 0, jl = itemsOpaque.length; j < jl; j++) {
                            ...
                            if (item._killed !== true && ( item.performance === _c.STATIC || this.castsShadowsMovable ) && _uti.boundsIntersect(itemBounds, bounds)) {
                                ...
                                if ( item.changed ) {
                                    ...
                                    && ( ( anim !== item._animCastShadow && ( anim.opaqueOffset || ( item._animCastShadow && item._animCastShadow.opaqueOffset ) ) )
                                    || ( anim.changed && anim.opaqueOffset && anim.opaqueOffset.tiles ) ) ) {
            ...
            _initShadowCasting: function () {
                ...
                if ( !this._shadowCastingInitialized ) {
                    ...
                    this._utilVec2Samples1 = _utv2.vector();
                    this._utilVec2Samples2 = _utv2.vector();
                    this._utilVec2Samples3 = _utv2.vector();
            ...
            castShadows: function () {
                ...
                var center = _utv2.set(this._utilVec2Samples1, this.boundsDraw.minX + this.boundsDraw.width * 0.5, this.boundsDraw.minY + this.boundsDraw.height * 0.5);
                var i, il;
                ...
                if (this.samples === 1) {
                    ...
                    for (i = 0, il = this.items.length; i < il; i++) {
                        ...
                        this.items[ i ].castShadow( this, context, center, this.bounds );
                    ...
                    for (var s = 0; s < this.samples; ++s) {
                        ...
                        for (i = 0, il = this.items.length; i < il; i++) {
                            ...
                            this.items[ i ].castShadow( this, context, this._utilVec2Samples3, this.bounds );
            ...
            recordChanges: function (force) {
                ...
                if (this.alpha === 0) {
                    ...
                    this._dirtySize = this._scaleComputedAt !== this.scale
                        || this.radius - this._radiusLast !== 0
                        || this.size.x - this._sizeLast.x !== 0
                        | this.size.y - this._sizeLast.y !== 0;
            ...
            draw: function () {
                ...
                if (this.dynamicColor && this._dirtyColor) {
                    ...
                    image.finalize( this.pixelPerfect ? 1 : this.scale );
        ...
        if (ig.global.wm) {
            ...
            ig.EntityLight.inject({
                ...
                drawShadows: function () {
                    ...
                    this.image.dataContext.clearRect(0, 0, diameter, diameter);
                    this.image.dataContext.drawImage( this.imageBase.data, 0, 0 );
                    this.image.finalize( this.pixelPerfect ? 1 : this.scale );
