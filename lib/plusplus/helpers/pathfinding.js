    ...
    .defines(function() {
        ...
        ig.pathfinding.getNeighbors = function(node){
            ...
            if ( top ) {
                ...
                if ( top.walkable && ig.pathfinding.isDirectionWalkable( top, 0, -1, node ) ) {
            ...
            if ( right ) {
                ...
                if ( right.walkable && ig.pathfinding.isDirectionWalkable( right, 1, 0, node ) ) {
            ...
            if ( bottom ) {
                ...
                if ( bottom.walkable && ig.pathfinding.isDirectionWalkable( bottom, 0, 1, node ) ) {
            ...
            if ( left ){
                ...
                if ( left.walkable && ig.pathfinding.isDirectionWalkable( left, -1, 0, node ) ) {
...
*/
                    ...
                    if ( cell && cell.length > 0 ) {
                        ...
                        for ( var i = 0, il = cell.length; i < il; i++ ) {
                            ...
                            if ( entity !== entityPathing
								...
								&& ( entity.collides !== ig.Entity.COLLIDES.NONE
         ...
         * @param {Number} [nodeFrom] node traveling from
         */
				...
				if ( DIAGONAL_REQUIRES_BOTH_DIRECT ) {
					...
					if ( dirX > 0 ) {
						...
						if ( dirY > 0 ) {
							...
							if ( !nm.bottom || !nm.bottom.walkable ) {
						...
						else if ( !nm.top || !nm.top.walkable ) {
					...
					if ( dirX > 0 ) {
						...
						if ( dirY > 0 ) {
							...
							if ( ( !nm.right || !nm.right.walkable ) && ( !nm.bottom || !nm.bottom.walkable ) ) {
						...
						else if ( ( !nm.right || !nm.right.walkable ) && ( !nm.top || !nm.top.walkable ) ) {
						...
						if ( dirY > 0 ) {
							...
							if ( ( !nm.left || !nm.left.walkable ) && ( !nm.bottom || !nm.bottom.walkable ) ) {
						...
						else if ( ( !nm.left || !nm.left.walkable ) && ( !nm.top || !nm.top.walkable ) ) {
