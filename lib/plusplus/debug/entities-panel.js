                            ...
                            if ( res.tile.x ) {
                                ...
                                if ( vertices && tilesize ) {
                                    ...
                                    for (k = 0, kl = vertices.length; k < kl; k++) {
                                        ...
                                        this._debugDrawLine(false, this._debugColors.collisionMap,
                                            ( res.tile.xPos.x + vertices[ k ].x ) * tilesize, ( res.tile.xPos.y + vertices[ k ].y ) * tilesize,
                                            ( res.tile.xPos.x + vertices[ k === kl - 1 ? 0 : k + 1 ].x ) * tilesize, ( res.tile.xPos.y + vertices[ k === kl - 1 ? 0 : k + 1 ].y ) * tilesize
                                        );
                            ...
                            if ( res.tile.y ) {
                                ...
                                if ( vertices && tilesize ) {
                                    ...
                                    for (k = 0, kl = vertices.length; k < kl; k++) {
                                        ...
                                        this._debugDrawLine(false, this._debugColors.collisionMap,
                                            ( res.tile.yPos.x + vertices[ k ].x ) * tilesize, ( res.tile.yPos.y + vertices[ k ].y ) * tilesize,
                                            ( res.tile.yPos.x + vertices[ k === kl - 1 ? 0 : k + 1 ].x ) * tilesize, ( res.tile.yPos.y + vertices[ k === kl - 1 ? 0 : k + 1 ].y ) * tilesize
                                        );
