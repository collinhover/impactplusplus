ig.module(
    ...
    .defines(function () {
            ...
            _debugDraw: function () {
                ...
                for (var i = 0, il = this.layers.length; i < il; i++) {
                    ...
                    for (var j = 0, jl = items.length; j < jl; j++) {
                        ...
                        // bounds base
                        if (ig.EntityExtended._debugShowBoundsBase && item.boundsBase) {

                            context.strokeStyle = this._debugColors.bounds;
                            context.lineWidth = 1.0;
                            context.strokeRect(
                                ig.system.getDrawPos(item.boundsBase.minX - screenX) - 0.5,
                                ig.system.getDrawPos(item.boundsBase.minY - screenY) - 0.5,
                                item.boundsBase.width * ( item.scale || ig.system.scale ),
                                item.boundsBase.height * ( item.scale || ig.system.scale )
                            );
                        ...
                        if (ig.EntityExtended._debugShowBounds && item.bounds) {
                            ...
                            context.strokeRect(
                                ...
                                item.bounds.width * ( item.scale || ig.system.scale ),
                                item.bounds.height * ( item.scale || ig.system.scale )
                            );
                        ...
                        if (ig.EntityExtended._debugShowBoundsDraw && item.boundsDraw) {
                            ...
                            context.strokeRect(
                                ...
                                item.boundsDraw.width * ( item.scale || ig.system.scale ),
                                item.boundsDraw.height * ( item.scale || ig.system.scale )
                            );
        ...
        ig.EntityExtended._debugShowBoundsBase = false;
