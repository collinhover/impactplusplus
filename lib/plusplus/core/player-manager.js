ig.module(
    ...
    .defines(function () {
        ...
        ig.PlayerManager = ig.global.PlayerManager = ig.Class.extend(/**@lends ig.PlayerManager.prototype */{
            ...
            /**
             * Manages an entity by calling {@link ig.PlayerManager#manageStart} if valid new entity, or {@link ig.PlayerManager#manageStop} if no entity passed.
            ...
            manageStart: function ( entity ) {
                ...
                this.entity = entity;
                this.entity.onRemoved.addOnce( this.manageStop, this );
            ...
            /**
             * Stops managing entityy, attempts to call entity's "manageStop" method, and dispatches {@link ig.PlayerManager#onManageStopped}.
            ...
            manageStop: function () {
                ...
                entity.onRemoved.remove( this.manageStop, this );
