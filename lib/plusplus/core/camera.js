ig.module(
    ...
    .defines(function () {
        ...
        ig.Camera = ig.Class.extend(/**@lends ig.Camera.prototype */{
             ...
             */
            trapBounds: _uti.boundsMinMax(
				_c.CAMERA.TRAP_BOUNDS_MINX,
				_c.CAMERA.TRAP_BOUNDS_MINY,
				_c.CAMERA.TRAP_BOUNDS_MAXX,
				_c.CAMERA.TRAP_BOUNDS_MAXY
			),
             ...
             * @see ig.CONFIG.CAMERA
             */
            trapBoundsPct: _uti.boundsMinMax(
				_c.CAMERA.TRAP_BOUNDS_PCT_MINX,
				_c.CAMERA.TRAP_BOUNDS_PCT_MINY,
				_c.CAMERA.TRAP_BOUNDS_PCT_MAXX,
				_c.CAMERA.TRAP_BOUNDS_PCT_MAXY
			),

            /**
             * Whether to always try to keep centered on entity camera is following.
			 * <span class="alert"><strong>IMPORTANT:</strong> this will override {@link ig.Camera#trapBounds} and {@link ig.Camera#trapBoundsPct}.</span>
             * @type Boolean
             * @default
             */
            ...
            // maximum coordinates when locking camera within level
            _minX: 0,
            _minY: 0,
            _maxX: 0,
            _maxY: 0,
            ...
            follow: function (entity, snap, center) {
                ...
                if (this.entity !== entity || snap || center) {
                    ...
                    if ( this.entity ) {
                        ...
                        _uti.boundsCopy(this._boundsScreen, this.trapBounds, ig.game.screen.x, ig.game.screen.y);
            ...
            updateFollow: function () {
                ...
                if (this.entity) {
                    ...
                    if (this.keepInsideLevel.x) {
                        ...
                        if (screenNextX <= this._minX ) {

                            screenNextX = this._minX;

                        }
                        else if(screenNextX >= this._maxX) {

                            screenNextX = this._maxX;
                    ...
                    if (this.keepInsideLevel.y) {
                        ...
                        if (screenNextY <= this._minY ) {

                            screenNextY = this._minY;

                        }
                        else if(screenNextY >= (this._maxY)) {

                            screenNextY = this._maxY;
                    ...
                    if (this.transitioning) {
                        ...
                        if (this.transitionPct >= 1 || ( noteX && noteY )) {
                            ...
                            _uti.boundsCopy(this._boundsScreen, this.trapBounds, screen.x, screen.y);
                        ...
                        if ( screen.x - this.screenLast.x !== 0 ) {
                            ...
                            _uti.boundsCopyX(this._boundsScreen, this.trapBounds, screen.x);
                        ...
                        if ( screen.y - this.screenLast.y !== 0 ) {
                            ...
                            _uti.boundsCopyY(this._boundsScreen, this.trapBounds, screen.y);
            ...
            resize: function () {
                ...
                // trapBounds pct to trapBounds

                _uti.boundsCopy(this.trapBounds, this.trapBoundsPct, 0, 0, ig.system.width * 0.5, ig.system.height * 0.5);
                _uti.boundsCopy(this._boundsScreen, this.trapBounds, ig.game.screen.x, ig.game.screen.y);
            ...
            /**
             * Calculates the edge coordinates for the current level.
             */
            calculateLevelEdgeCoordinates: function(layer) {

                layer = typeof layer != 'undefined' ? layer : ig.game.collisionMap;

                if (this.keepInsideLevel.x = this.keepInsideLevel.y = _c.CAMERA.KEEP_INSIDE_LEVEL) {

                    this._minX = 0;
                    this._minY = 0;
                    this._maxX = layer.width * layer.tilesize - ig.system.width;
                    this._maxY = layer.height * layer.tilesize - ig.system.height;
                    ...
                    if (!this.keepCentered) {
                        ...
                        this._minX += this.trapBounds.minX;
                        this._minY += this.trapBounds.minY;
                        this._maxX += this.trapBounds.maxX;
                        this._maxY += this.trapBounds.maxY;
