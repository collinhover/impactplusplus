        ...
        ig.Camera = ig.Class.extend(/**@lends ig.Camera.prototype */{
            ...
            removeAtmosphere: function (duration) {
                ...
                if ( this.atmosphereOverlay ) {
                    ...
                    var atmosphereOverlay = this.atmosphereOverlay;
                    this.atmosphereOverlay = undefined;

                    if ( !atmosphereOverlay.added ) {

                        atmosphereOverlay.onAdded.remove( this._showAtmosphere, this );
                        ig.game.removeEntity(atmosphereOverlay);

                    }
                    else {

                        atmosphereOverlay.fadeOut({
