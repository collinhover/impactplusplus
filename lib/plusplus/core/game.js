ig.module(
    ...
    .defines(function() {
         ...
         */
        ig.GameExtended.SORT.Z_INDEX = ig.Game.SORT.Z_INDEX = function(a, b) {
            return (a.zIndex || 0) - (b.zIndex || 0);
        };

        ig.GameExtended.SORT.POS_X = ig.Game.SORT.POS_X = function(a, b) {
            return ((a.pos && a.size && (a.pos.x + a.size.x)) || 0) - ((b.pos && b.size && (b.pos.x + b.size.x)) || 0);
        };

        ig.GameExtended.SORT.POS_Y = ig.Game.SORT.POS_Y: function(a, b) {
