ig.module(
    ...
    .defines(function () {
        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
             ...
             * @default
             */
            gravity: _c.TOP_DOWN.ENABLED ? 0 : 400,
                    ...
                    if ( playerSpawnerName ) {
                        ...
                        if ( player && playerSpawner ) {
                            ...
                            // else move to
                                ...
                                player.moveToEntityPosition( playerSpawner );
                ...
                if (!layerName) {
                    ...
                    if (layer && entityClass) {
                        ...
                        for (i = 0, il = items.length; i < il; i++) {
                            ...
                            if (!item._killed && item instanceof entityClass && ( !bounds || _uti.boundsIntersect( bounds, item.bounds ) ) ) {
            ...
            /**
             * Gets all entities matching group(s).
             * @param {Bitflag|Number} group group(s) to search.
             * @param {Object} [settings] settings for search.
             * @returns {Array} all found entities.
             * @see ig.Game#getEntitiesByType
             **/
                ...
                if (!layerName) {
                    ...
                    for (i = 0, il = this.layers.length; i < il; i++) {
                        ...
                        if (layer.numEntities) {
                            ...
                            var layerMatching = this.getEntitiesByGroup(group, settings);
                    ...
                    if (layer) {
                        ...
                        for (i = 0, il = items.length; i < il; i++) {
                            ...
                            if ( ( item.group & group ) && !item._killed && ( !bounds || _uti.boundsIntersect( bounds, item.bounds ) ) ) {
