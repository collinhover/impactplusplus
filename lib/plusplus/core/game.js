        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
            ...
            loadLevel: function (level, playerSpawnerName) {
                ...
                if ( !this.preloader.ready ) {
                    ...
                    this.preloader.delayLevelLoad(level, this._playerSpawnerName);
                    return;
                ...
                if ( level ) {
                    ...
                    if ( this.hasLevel && _c.TRANSITION_LEVELS && this.layersMap[ _c.TRANSITIONER_LAYER ] && this.layersMap[ _c.TRANSITIONER_LAYER ].ignorePause ) {
                        ...
                        if ( !this.preloader.transitioner ) {

                            this.preloader.createTransitioner();

                        }

                        this.preloader.transitioner.fadeTo(1, {
                            onComplete: function () {
            ...
            buildLevel: function () {
                ...
                if ( levelData ) {
                    ...
                    if ( levelChangeEntities.length ) {

                        for (i = 0, il = levelChangeEntities.length; i < il; i++) {

                            var level = levelChangeEntities[i].settings.levelName;
                            var levelName = level.replace(/^(Level)?(\w)(\w*)/, function (m, l, a, b) {
                                return a.toUpperCase() + b;
                            });
                    ...
                    if ( this.preloader.transitioner ) {
                        ...
                        if ( !this.preloader.transitioner.added ) {

                            this.spawnEntity( this.preloader.transitioner, 0, 0, { alpha: 1 } );

                        }

                        this.preloader.transitioner.fadeToDeath();
                        this.preloader.transitioner = undefined;
