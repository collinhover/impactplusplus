        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
            ...
            _addDeferredItem: function ( item ) {
                ...
                if (!item._layerChange) {
                    ...
                    if (item.ready && ( this._isReady || item instanceof ig.UIElement ) ) {
            ...
            /**
             * Pauses game.
             * @param {Boolean} [silent=false] whether to show no visible sign of pause (i.e. no dimming)
             **/
