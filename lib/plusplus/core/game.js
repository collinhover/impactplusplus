ig.module(
    ...
    .defines(function () {
        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
            ...
            /**
             * Get the player object. This method searches for players according to the following priorities...
             * <ol>
             *   <li>Entity name</li>
             *   <li>Entity class is Player</li>
             *   <li>Entity type is PLAYER</li>
             * </ol>
             **/
            getPlayer: function () {

                var player = ig.game.namedEntities[ "player" ]
                        || ig.game.getEntitiesByClass( ig.Player ) [0]
                        || ig.game.getEntitiesByType( ig.EntityExtended.TYPE.PLAYER ) [0];
