        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
            ...
            spawnEntity: function (type, x, y, settings) {
                ...
                if (EntityClass instanceof ig.EntityExtended) {
                    ...
                    // we're already adding this entity
                    // but it is deferred
            ...
            addItem: function (item, settings ) {
                ...
                // only allow add when not removing and not already adding or changing layers

                item._layerChange = settings.forChange || false;

                if ( !item._layerNameRemove && ( !item._layerNameAdd || item._layerChange ) ) {
