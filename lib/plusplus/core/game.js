        ...
        ig.GameExtended = ig.Game.extend(/**@lends ig.GameExtended.prototype */{
            ...
            getPlayer: function (settings) {
                ...
                return this.namedEntities[ "player" ]
                    || ( this.canSearchForPlayerByClass && this.getEntitiesByClass( "Player", settings || { first: true } )[0] )
                    || ( this.canSearchForPlayerByType && this.getEntitiesByType( ig.EntityExtended.TYPE.PLAYER, settings || { first: true } )[0] );
            ...
            resize: function () {
                ...
                if ( _c.SCALE_MIN > scale ) {

                    scale = _c.SCALE_MIN;

                }

                if ( _c.SCALE_MAX > 0 && _c.SCALE_MAX < scale ) {
