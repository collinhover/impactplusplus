    ...
    .defines(function() {
        ...
        ig.LoaderExtended = ig.Loader.extend( /**@lends ig.LoaderExtended.prototype */ {
            ...
            init: function(gameClass, resources) {
                ...
                gameClass.prototype.resize.call(this);
            ...
            run: function() {
                ...
                if (t < _c.DURATION_FADE) {
                    ...
                    this.draw();
                    alpha = _utm.map(t, 0, _c.DURATION_FADE, 0, 1);
                } else if (t < _c.DURATION_FADE * 2) {
                    // Draw the game -> fade from white
                    ig.game.run();
                    alpha = _utm.map(t, _c.DURATION_FADE, _c.DURATION_FADE * 2, 1, 0);
                } else {
                    // All done! Dismiss the loader completely, set the delegate
                    // to ig.game
