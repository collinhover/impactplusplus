ig.module(
    ...
    .defines(function () {
         ...
         * <br>- 2. instead of using the get methods, hook into the {@link ig.Input#onAddedInputPoint} and {@link ig.Input#onRemovedInputPoint} signals
        ...
        ig.Input.inject(/**@lends ig.Input.prototype */{
            ...
            /**
             * Signal dispatched when an input point begins.
             * <br>- created on init.
             * @type ig.Signal
             */
            onAddedInputPoint: null,

            /**
             * Signal dispatched when an input point is no longer active.
             * <br>- created on init.
             * @type ig.Signal
             */
            onRemovedInputPoint: null,

            /**
             * Initializes Input and adds signals for when input points are added or removed.
             * @see ig.Input
             **/
            init: function () {
                ...
                this.onAddedInputPoint = new ig.Signal();
                this.onRemovedInputPoint = new ig.Signal();
            ...
            getInputPoint: function (parameters) {
                ...
                if (!inputPoint) {
                    ...
                    this.onAddedInputPoint.dispatch(inputPoint);
            ...
            removeInputPoint: function (parameters) {
                ...
                if (inputPoint) {
                    ...
                    this.onRemovedInputPoint.dispatch(inputPoint);
        ...
        ig.InputPoint = ig.Class.extend(/**@lends ig.InputPoint.prototype */{
            ...
            /**
             * Signal dispatched when input point taps.
             * <br>- created on init.
             * @type ig.Signal
             */
            onTapped: null,
            ...
            /**
             * Signal dispatched when input point holds.
             * <br>- created on init.
             * @type ig.Signal
             */
            onHoldStarted: null,
            ...
            /**
             * Signal dispatched when input point holds until activation, i.e. long hold.
             * <br>- created on init.
             * @type ig.Signal
             */
            onHoldActivated: null,

            /**
             * Signal dispatched when input point swipes.
             * <br>- created on init.
             * @type ig.Signal
             */
            onSwiped: null,
            ...
            init: function (x, y, id) {
                ...
                this.onTapped = new ig.Signal();
                this.onHoldStarted = new ig.Signal();
                this.onHoldActivated = new ig.Signal();
                this.onSwiped = new ig.Signal();
            ...
            update: function () {
                ...
                if (this.down) {
                    ...
                    if (!this.holding && this.duration >= _g.HOLD_DELAY) {
                        ...
                        this.onHoldStarted.dispatch(this);
                    ...
                    if (this._holdingActivatable && !this.holdingActivate && this.duration >= _g.HOLD_DELAY_ACTIVATE) {
                        ...
                        this.onHoldActivated.dispatch(this);
