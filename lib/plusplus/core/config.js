ig.module(
    ...
    .defines(function () {
        ...
        // lets not erase existing config

        var existingConfig = ig.CONFIG;
         ...
         * @example
         * // define 'ig.CONFIG' before Impact++ loads its config
         * // then your config will be automatically merged over Impact++'s config
         * ig.CONFIG = {.. your config ..};
         * // my recommendation is to define ig.CONFIG in your main module file
         * // right before your main module is defined
         * ig.module( 'game.main' )..
         * @static
         * @readonly
         * @memberof ig
         ...
         * @memberof ig.CONFIG
         */
        ig.CONFIG.LOADER_BAR_COLOR = 'rgb(255,255,255)';
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_UNGROUNDED_X = 100;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_UNGROUNDED_Y = 200;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_GROUNDED_X = 100;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_GROUNDED_Y = 100;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_CLIMBING_X = 75;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MAX_VEL_CLIMBING_Y = 75;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.FRICTION_UNGROUNDED_X = 0;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.FRICTION_UNGROUNDED_Y = 0;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.FRICTION_GROUNDED_X = 1600;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.FRICTION_GROUNDED_Y = 1600;
        ...
        /**
         * Modifier when character moving on slope.
         * @type Number
         * @default
         * @memberof ig.CONFIG.ENTITY
         */
         ...
         */
        ig.CONFIG.ENTITY.JUMP_FORCE = 10;
         ...
         */
        ig.CONFIG.ENTITY.JUMP_CONTROL = 0.75;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.UNGROUNDED_FOR_THRESHOLD = 0.1;
         ...
         */
        ig.CONFIG.ENTITY.CLIMBING_CONTROL = 1;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.MOVE_TO_STUCK_FOR_THRESHOLD = 0.5;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.REGEN_RATE_HEALTH = 0;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.REGEN_RATE_ENERGY = 0;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.EXPLODING_DAMAGE = true;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.EXPLODING_DAMAGE_PARTICLE_COUNT = 3;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.EXPLODING_DEATH = true;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.ENTITY.EXPLODING_DEATH_PARTICLE_COUNT = 10;

        // merge in existing config over this config

        ig.merge( ig.CONFIG, existingConfig );
