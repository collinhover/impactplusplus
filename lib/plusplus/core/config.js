ig.module(
    ...
    .defines(function () {
         ...
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.CAN_FLEE = false;
        ...
        /**
         * Whether creatures can wander randomly.
         * @type Boolean
         * @default
         * @memberof ig.CONFIG.CREATURE
         */
        ig.CONFIG.CREATURE.CAN_WANDER = true;
         ...
         * @memberof ig.CONFIG.PATHFINDING
         */
        ig.CONFIG.PATHFINDING.WEIGHT_AWAY_FROM = 10;
