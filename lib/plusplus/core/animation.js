    ...
    .defines(function () {
        ...
        ig.AnimationExtended = ig.Animation.extend(/**@lends ig.AnimationExtended.prototype */{
            ...
            init: function (sheet, settings) {
                ...
                this.sheet = sheet;
                this.pivot = {x: sheet.width * 0.5, y: sheet.height * 0.5 };
                ...
                draw: function (targetX, targetY) {
                    ...
                    if (this.texturing) {
                        ...
                        if (this.computeDrawCount >= this.computeDrawCountMax) {
                            ...
                            if (this.textureWidth * ig.system.scale !== this.texturing.boundsDraw.width * ig.system.scale || this.textureHeight * ig.system.scale !== this.texturing.boundsDraw.height * ig.system.scale) {
