        ...
        ig.Layer = ig.Class.extend(/**@lends ig.Layer.prototype */{
            ...
            reset: function () {
                ...
                if (this.clearOnLoad) {
                    ...
                    this.items.length = this.itemsTargetable.length = this.itemsInteractive.length = this.itemsOpaque.length = this.itemsLight.length = 0;
            ...
            pause: function () {
                ...
                if (!this.ignorePause && this.paused !== true) {
                    ...
                    this.noUpdateLast = this.noUpdate;
                    this.noUpdate = false;
                    this.paused = true;
            ...
            unpause: function () {
                ...
                if (this.paused !== false) {
                    ...
                    this.noUpdate = this.noUpdateLast;
                    this.paused = false;
            ...
            /**
             * Cleans layer just before remove.
             */
            cleanup: function () {
            ...
            update: function () {
                ...
                // should update and has items

                if (!this.paused && !this.noUpdate && this.items.length > 0) {
