ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
            ...
            createAnim: function (name, settings) {
				...
				if ( name ) {
					...
					this.addAnim("idle", settings );
					this.addAnim("idleX", settings );
					this.addAnim("idleY", settings );
					this.addAnim("idleLeft", settings );
					this.addAnim("idleRight", settings );
					this.addAnim("idleUp", settings );
					this.addAnim("idleDown", settings );
                ...
                if ( weak ) {
                    ...
                    if ( this === weak ) {
                        ...
                        // vertical separation
                            ...
                            if( entity.collides === ig.Entity.COLLIDES.FIXED && dirY > 0 && Math.abs(this.vel.y - entity.vel.y) < this.minBounceVelocity ) {
                    ...
                    // vertical separation
                        ...
                        if ( dirY > 0 ) {
                            ...
                            nudgeX = entity.collides === ig.Entity.COLLIDES.FIXED && entity.vel.x * ig.system.tick;
         ...
         * @type Number
         * @memberof ig.Entity.COLLIDES
         **/
        ig.Entity.COLLIDES.DOUBLEFIXED = ig.Entity.COLLIDES.FIXED + ig.Entity.COLLIDES.FIXED;

        var COLLISION_ACTIVE = ig.Entity.COLLIDES.ACTIVE;
        var COLLISION_DOUBLEFIXED = ig.Entity.COLLIDES.DOUBLEFIXED;
