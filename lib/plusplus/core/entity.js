    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
            ...
            refresh: function (force) {
                ...
                else if ( this.performance === _c.STATIC && this.changed ) {
            ...
            moveTo: function ( item, settings ) {
                ...
                if (item && this.movingTo !== item) {
                    ...
                    var singleMove = !this.fixed && this.performance === _c.STATIC;
                    ...
                    if ( item instanceof ig.EntityExtended ) {
                        ...
                        if ( ( settings.matchPerformance || this.ignoreSystemScale ) && this.performance !== _c.MOVABLE ) {

                            this.setPerformance(_c.MOVABLE);
                ...
                if ( weak ) {
                    ...
                    if ( this === weak ) {
                        ...
                        // vertical separation
                            ...
                            if( entity.collides >= ig.EntityExtended.COLLIDES.ACTIVE && dirY > 0 && Math.abs(this.vel.y - entity.vel.y) < this.minBounceVelocity ) {
                    ...
                    // vertical separation
                        ...
                        if ( dirY > 0 ) {
                            ...
                            nudgeX = entity.collides >= ig.EntityExtended.COLLIDES.ACTIVE && entity.vel.x * ig.system.tick;
            ...
            handleMovementTrace: function( res ) {
                ...
                if ( res.tile.y && _utt.isTileClimbable( res.tile.y ) ) {
                    ...
                    if ( this._climbingIntentDown ) {
                        ...
                        nonBlocking = this._climbingIntentUp || this.gravityFactor === 0;
