ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
             ...
             * @type Boolean
             */
            grounded: _c.TOP_DOWN ? true : false,
            ...
            /**
             * Entity base bounds, based only on position and size.
             * <br>- bounds effectively replaces entity.size, and allows entities to vary the way they construct their sizes
             * <br>- {@link ig.EntityExtended#boundsBase} accounts for position and size
             * <br>- {@link ig.EntityExtended#bounds} accounts for position, size, and rotation
             * <br>- {@link ig.EntityExtended#boundsDraw} accounts for position, size, offsets, and rotation
             * <span class="alert"><strong>IMPORTANT:</strong> for increased performance, when {@link ig.EntityExtended#angle} = 0, bounds = boundsBase!</span>
            ...
            createAnim: function (name, settings) {
                ...
                this.addAnim(name || ( this.animInit ? this.animInit : 'idle' ), settings );
            ...
            getBounds: function () {
                ...
                if ( this.angle !== 0 ) {
                    ...
                    this.bounds = ig.utilsintersection.boundsCopyRotated( this.bounds, bounds, this.angle );
            ...
            distanceEdgeTo: function( entity ) {
                ...
                var entityMinX = entity.bounds.minX;
                var entityMaxX = entity.bounds.maxX;
                var entityMinY = entity.bounds.minY;
                var entityMaxY = entity.bounds.maxY;
                var distanceX;
                var distanceY;
             ...
             **/
            castShadow: function (light, context, point, contextBounds) {
                ...
                if ( withinLight ) {
                    ...
                    if (light.pixelPerfect) {
                        ...
                        for (i = 0, il = contours.length; i < il; i++) {
                            ...
                            contour = contours[ i ];
                            _utd.fillPolygon(context, contour.vertices, -contextBounds.minX, -contextBounds.minY, light.scale);
                ...
                if ( item instanceof ig.EntityExtended ) {
                    ...
                    if ( settings ) {
                        ...
                        if (offsetPct) {
                            ...
                            targetX += ( offsetX * item.bounds.width * 0.5 + offsetX * this.bounds.width * 0.5 ) * ( item.flip.x ? -1 : 1 );
                            targetY += offsetY * item.bounds.height * 0.5 + offsetY * this.bounds.height * 0.5;
                    ...
                    targetX += item.bounds.minX + alignX * ( item.bounds.width - this.bounds.width * scaleMod );
                    targetY += item.bounds.minY + alignY * ( item.bounds.height - this.bounds.height * scaleMod );
                ...
                // assume item is position
                    ...
                    if ( settings ) {
                        ...
                        if (offsetPct) {
                            ...
                            targetX += offsetX * this.bounds.width * 0.5;
                            targetY += offsetY * this.bounds.height * 0.5;

                        }

                    }

                    targetX += item.x + alignX * this.bounds.width;
                    targetY += item.y + alignY * this.bounds.height;
            ...
            lookAt: function (target) {
                ...
                if (target && this !== target && !target.fixed) {
                    ...
                    if (!_c.TOP_DOWN) {
                        ...
                        this.flip.x = centerX > targetCenterX;
                        ...
                        if ( this.added ) {
                            ...
                            centerY = this.bounds.minY + this.bounds.height * 0.5;
                        ...
                        if ( target.added ) {
                            ...
                            targetCenterY = target.bounds.minY + target.bounds.height * 0.5;
                        ...
                        if (Math.abs(xDiff) > Math.abs(yDiff)) {
                            ...
                            this.currentAnim = this.anims.moveX;
                            this.flip.x = xDiff > 0;
                            ...
                            if (!_c.FLIP_Y) {
                                ...
                                this.currentAnim = (yDiff > 0) ? this.anims.moveUp : this.anims.moveDown;

                            }
                            else {

                                this.currentAnim = this.anims.moveY;
                                this.flip.y = yDiff > 0;
                ...
                if ( weak ) {
                    ...
                    if ( this === weak ) {
                        ...
                        if ( dirX !== 0 ) {
                            ...
                            res = ig.game.collisionMap.trace( this.bounds.minX, this.bounds.minY, nudge, 0, this.bounds.width, this.bounds.height );
                        ...
                        // vertical separation
                            ...
                            // on a moving entity (ex: platform)

                            var nudgeX = 0;

                            if( dirY > 0 && Math.abs(this.vel.y - entity.vel.y) < this.minBounceVelocity ) {
                            ...
                            res = ig.game.collisionMap.trace( this.bounds.minX, this.bounds.minY, nudgeX, nudge, this.bounds.width, this.bounds.height );
                        ...
                        if ( res.pos.x !== this.pos.x || res.pos.y !== this.pos.y ) {
                            ...
                            if ( this.angle !== 0 ) {
                                ...
                                this.pos.x = res.pos.x + ( this.boundsBase.minX - this.bounds.minX );
                                this.pos.y = res.pos.y + ( this.boundsBase.minY - this.bounds.minY );
                    ...
                    if ( dirX !== 0 ) {
                        ...
                        res = ig.game.collisionMap.trace( this.bounds.minX, this.bounds.minY, nudge * 0.5, 0, this.bounds.width, this.bounds.height );
                    ...
                    // vertical separation
                        ...
                        if ( unfair ) {
                            ...
                            res = ig.game.collisionMap.trace( this.bounds.minX, this.bounds.minY, nudgeX, nudge * 0.5, this.bounds.width, this.bounds.height );
                    ...
                    if (!this.frozen) {
                        ...
                        // movable or moving entities
                            ...
                            if (this.performance === _c.DYNAMIC && !this._killed) {
                                ...
                                var res = ig.game.collisionMap.trace(this.bounds.minX, this.bounds.minY, mx, my, this.bounds.width, this.bounds.height);
            ...
            draw: function () {
                ...
                if (this.currentAnim && this.visible) {
                    ...
                    var minX = this.boundsDraw.minX;
                    var minY = this.boundsDraw.minY;
                    ...
                    if ( this.angle !== 0 ) {
                        ...
                        minX += ( this.boundsDraw.width - this.currentAnim.sheet.width ) * 0.5;
                        minY += ( this.boundsDraw.height - this.currentAnim.sheet.height ) * 0.5;
        ...
        ig.Entity.solveCollision = function (a, b) {
            ...
            if ( a.collides === ig.Entity.COLLIDES.LITE
                || b.collides === ig.Entity.COLLIDES.FIXED ) {

                weak = a;

            }
            else if ( b.collides === ig.Entity.COLLIDES.LITE
            ...
            if (overlapY > overlapX) {
                ...
                nudge = left.bounds.maxX - right.bounds.minX;
                vel = (left.vel.x - right.vel.x) * 0.5;

                left.collideWith(right, 1, 0, -nudge, -vel, weak);
                right.collideWith(left, -1, 0, nudge, vel, weak);

            }
            // default to higher overlap on x axis, i.e. vertical collision
            else {

                nudge = top.bounds.maxY - bottom.bounds.minY;
                vel = (top.vel.y - bottom.vel.y) * 0.5;

                top.collideWith(bottom, 0, 1, -nudge, -vel, weak);
                bottom.collideWith(top, 0, -1, nudge, vel, weak);
