ig.module(
    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
             ...
             */
            friction: {x: _c.ENTITY.FRICTION_X, y: _c.ENTITY.FRICTION_Y},
             ...
             */
            maxVel: {x: _c.ENTITY.MAX_VEL_X, y: _c.ENTITY.MAX_VEL_Y},
             ...
             */
            slopeStanding: {min: _utm.degreesToRadians(_c.ENTITY.SLOPE_STANDING_MIN), max: _utm.degreesToRadians(_c.ENTITY.SLOPE_STANDING_MAX) },
            ...
            distanceTo: function( from ) {
                ...
                if ( from instanceof ig.EntityExtended ) {
                    ...
                    distanceX = (this.pos.x + this.size.x * 0.5) - (from.pos.x + from.size.x * 0.5);
                    distanceY = (this.pos.y + this.size.y * 0.5) - (from.pos.y + from.size.y * 0.5);

                }
                else {

                    distanceX = (this.pos.x + this.size.x * 0.5) - from.x;
                    distanceY = (this.pos.y + this.size.y * 0.5) - from.y;
            ...
            /**
             * Calculates distance squared from center of this entity to center of another entity or position.
            ...
            angleTo: function( from ) {
                ...
                if ( from instanceof ig.EntityExtended ) {
                    ...
                    return Math.atan2(
                        (this.pos.x + this.size.x * 0.5) - from.x,
                        (this.pos.y + this.size.y * 0.5) - from.y
                    );
            ...
            castShadow: function (light, context, point, minX, minY, radius) {
                ...
                if (!this._contours) {
                    ...
                    this._utilVec2Cast1 = { x: 0, y: 0 };
                    this._utilVec2Cast2 = { x: 0, y: 0 };
                    this._utilVec2Cast3 = { x: 0, y: 0 };
                    this._utilVec2Cast4 = { x: 0, y: 0 };

                    this._utilVec2Project1 = { x: 0, y: 0 };
                    this._utilVec2Project2 = { x: 0, y: 0 };
                    this._utilVec2Project3 = { x: 0, y: 0 };
                    this._utilVec2Project4 = { x: 0, y: 0 };
            ...
            moveTo: function ( item, settings ) {
                ...
                if (item && this.movingTo !== item) {
                    ...
                    if (settings.randomOffsetPct) {
                        ...
                        settings.baseOffsetPct = settings.baseOffsetPct || settings.offsetPct || { x: 0, y: 0 };
                ...
                if ( weak ) {
                    ...
                    if ( this === weak ) {
                        ...
                        // vertical separation
                            ...
                            if( ( entity.collides >= ig.EntityExtended.COLLIDES.FIXED || this.collides === ig.EntityExtended.COLLIDES.LITE ) && dirY > 0 && Math.abs(this.vel.y - entity.vel.y) < this.minBounceVelocity ) {
            ...
            handleMovementTrace: function( res ) {
                ...
                if ( wasGrounded && wasGrounded !== this.grounded && !this.jumping ) {
                    ...
                    collisionMap = ig.game.collisionMap;
                    row = collisionMap.data[ Math.floor( ( this.pos.y + this.size.y + collisionMap.tilesize * 0.5 ) / collisionMap.tilesize ) ];
            ...
            recordChanges: function (force) {
                ...
                if (force === true
					...
					if ( this.vel.y !== 0 ) {
						...
						this.movingY = this.vel.y < 0 || !this.grounded || ( !!this.slope && this.movingX );
        ...
        ig.EntityExtended.checkPair = function (a, b) {
            ...
            if (( a.group & b.group ) === 0) {
                ...
                if ( a.collides && b.collides
                    && a.collides + b.collides > COLLISION_ACTIVE
                    && ( _c.COLLISION.ALLOW_FIXED || a.collides + b.collides < COLLISION_DOUBLEFIXED )
