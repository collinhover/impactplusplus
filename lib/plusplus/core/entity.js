    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
            ...
            spawn: function () {
                ...
                // start activated when activated upon spawn
            ...
            handleMovementTrace: function( res ) {
                ...
                if ( res.tile.y && _utt.isTileClimbable( res.tile.y ) && ( this._climbingIntentDown || this._climbingIntentUp || this.gravityFactor === 0 ) ) {
