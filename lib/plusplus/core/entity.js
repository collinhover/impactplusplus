    ...
    .defines(function () {
        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
            ...
            touches: function (other) {
                ...
                return _uti.boundsIntersect(this.bounds, other.bounds);
            ...
            moveToPosition: function (entity, settings) {
                ...
                var halfWidth = this.boundsDraw.width * 0.5;
                var halfHeight = this.boundsDraw.height * 0.5;
                var targetHalfWidth = entity.boundsDraw.width * 0.5;
                var targetHalfHeight = entity.boundsDraw.height * 0.5;

                var targetX = entity.boundsDraw.minX + targetHalfWidth - halfWidth;
                var targetY = entity.boundsDraw.minY + targetHalfHeight - halfHeight;
            ...
            update: function () {
                ...
                if (!this.frozen) {
                    ...
                    // movable or moving entities
                        ...
                        // physics entities that are not dead
            ...
            /**
             * Changes entity by updating move to.
             **/
        ...
        if (ig.global.wm) {
            ...
            delete ig.EntityExtended.prototype.touches;
