            ...
            moveToPosition: function (entity, settings) {
                ...
                if ( this.fixed ) {
                    ...
                    if ( entity.fixed ) {
                        ...
                        targetX = ( entity.bounds.minX + targetHalfWidth - halfWidth - ig.game.screen.x ).limit( ig.game.screen.x, ig.game.screen.x + ig.system.width - this.boundsDraw.width );
                        targetY = ( entity.bounds.minY + targetHalfHeight - halfHeight - ig.game.screen.y ).limit( ig.game.screen.y, ig.game.screen.y + ig.system.width - this.boundsDraw.height );
