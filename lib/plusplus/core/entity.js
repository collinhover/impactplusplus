        ...
        ig.EntityExtended = ig.Entity.extend(/**@lends ig.EntityExtended.prototype */{
            ...
            moveToPosition: function (item, settings) {
                ...
                if ( item instanceof ig.EntityExtended ) {
                    ...
                    var scaleMod = this.scale / ig.system.scale;
                    var itemScaleMod = item.scale / ig.system.scale;
                    ...
                    if ( settings ) {
                        ...
                        if (offset) {
                            ...
                            targetX += offset.x * itemScaleMod || 0;
                            targetY += offset.y * itemScaleMod || 0;
                        ...
                        if (offsetPct) {
                            ...
                            targetX += ( offsetX * ( item.size.x * 0.5 * itemScaleMod + this.size.x * 0.5 * scaleMod ) ) * ( item.flip.x ? -1 : 1 );
                            targetY += offsetY * ( item.size.y * 0.5 * itemScaleMod + this.size.y * 0.5 * scaleMod );
                    ...
                    targetX += item.pos.x + alignX * ( item.size.x * itemScaleMod - this.size.x * scaleMod );
                    targetY += item.pos.y + alignY * ( item.size.y * itemScaleMod - this.size.y * scaleMod );
