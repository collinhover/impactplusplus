        ...
        ig.Tutorial = ig.Spawner.extend(/**@lends ig.Tutorial.prototype */{
            ...
            setup: function (entity) {
                ...
                if (this.layerNameIsolation) {
                    ...
                    // gather isolated and include self and player for proper collision checks

                    var isolating = [ this, ig.game.getEntityByName('player') ];
                    var target;

                    for (var name in this.isolate) {

                        target = ig.game.getEntityByName(this.isolate[ name ]);
                    ...
                    for (var name in this.target) {
                        ...
                        target = ig.game.getEntityByName(this.target[ name ]);
            ...
            teardown: function () {
                ...
                if (this.layerNameIsolation) {
                    ...
                    var isolating = [ ig.game.getEntityByName('player') ];
