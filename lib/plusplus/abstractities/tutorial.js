        ...
        ig.Tutorial = ig.Spawner.extend(/**@lends ig.Tutorial.prototype */{
            ...
            resetExtras: function () {
                ...
                if (this.textSettings) {
                    ...
                    this.textSettings.posPct = this.textSettings.posPct || {x: 0.5, y: 0.4};
                    this.textSettings.align = this.textSettings.align || {x: 0.5, y: 0.5};
                    this.textSettings.linkAlign = this.textSettings.linkAlign || {x: 0, y: 0.4};
