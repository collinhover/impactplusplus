        ...
        ig.Tutorial = ig.Spawner.extend(/**@lends ig.Tutorial.prototype */{
            ...
            resetExtras: function () {
                ...
                if (this.textSettings) {
                    ...
                    this.textSettings.font = this.textSettings.font || ig.Font.FONTS.ALT;

                    // check position and alignment

                    this.textSettings.posPct = this.textSettings.posPct || {x: 0.5, y: 0.9};
                    this.textSettings.align = this.textSettings.align || this.textSettings.posPct;
                    this.textSettings.linkAlign = this.textSettings.linkAlign || {x: 0, y: 0.65};
            ...
            spawned: function (entity) {
                ...
                // when last entity is spawned start looping
            ...
            loopStart: function () {
                ...
                if (looping) {
                    ...
                    // tutorial should not be torndown while looping

                    var needsTeardown = this.needsTeardown;
