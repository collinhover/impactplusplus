        ...
        */
        ...
        updateWander: function () {
            ...
            if ( this.canWander && !this.tethering && !this.entityPrey && !this.entityPredator ) {
                ...
                // TODO: account for top down
                /*
                this.wanderDirection.y = Math.round( Math.random() * 2 - 1 );

                var tetherCenterY = this.entityTether.bounds.minY + this.entityTether.bounds.height * 0.5;

                if ( tetherCenterY - this.tetherDistance >= this.bounds.maxY ) {

                    this.wanderDirection.y = 1;

                }
                else if ( tetherCenterY + this.tetherDistance <= this.bounds.minY ) {
                ...
                */
                ...
                var wanderSwitchChance = this.wanderDirection.x === 0 ? this.wanderSwitchChanceStopped : this.wanderSwitchChance;
                ...
                // has direction
                    ...
                    this.wanderPos.x = this.bounds.minX + this.bounds.width * 0.5 + this.wanderDirection.x * this.bounds.width * 0.5;
                    this.wanderPos.y = this.bounds.minY + this.bounds.height * 0.5;// + this.bounds.height * this.wanderDirection.y;
