        ...
        ig.Character = ig.EntityExtended.extend(/**@lends ig.Character.prototype */{
            ...
            jump: function () {
                ...
                if (this.canJump) {
                    ...
                    if (( this.grounded || this.withinClimbables || this.ungroundedFor < this.ungroundedForThreshold ) && this.jumping !== true) {
