                ...
                if ( this.pathingTimer.delta() >= 0 && ( this.path.length === 0 || this.needsNewPath ) ) {
                    ...
                    if ( simple ) {
                        ...
                        if ( this.path.length === 0 ) {
                            ...
                            x = this.pos.x + halfWidth;
                            y = this.pos.y + halfHeight;
                            ...
                            // don't travel in diagonal direction unless unsafe pathing and gravity won't affect this entity

                            if ( !unsafe && dX !== 0 && dY !== 0 && !( this.gravityFactor === 0 || ig.game.gravity === 0 ) ) {
                            ...
                            if ( dY !== 0 ) {
                                ...
                                if ( dY * dY < halfHeight * halfHeight ) {
