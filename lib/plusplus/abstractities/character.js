ig.module(
    ...
    .defines(function() {
        ...
        ig.Character = ig.EntityExtended.extend( /**@lends ig.Character.prototype */ {
             ...
             */
            size: {
                x: _c.CHARACTER.SIZE_EFFECTIVE_X,
                y: _c.CHARACTER.SIZE_EFFECTIVE_Y
            },
             ...
             */
            offset: {
                x: _c.CHARACTER.SIZE_OFFSET_X,
                y: _c.CHARACTER.SIZE_OFFSET_Y
            },
             ...
             */
            maxVelUngrounded: {
                x: _c.CHARACTER.MAX_VEL_UNGROUNDED_X,
                y: _c.CHARACTER.MAX_VEL_UNGROUNDED_Y
            },
             ...
             */
            maxVelGrounded: {
                x: _c.CHARACTER.MAX_VEL_GROUNDED_X,
                y: _c.CHARACTER.MAX_VEL_GROUNDED_Y
            },
             ...
             */
            maxVelClimbing: {
                x: _c.CHARACTER.MAX_VEL_CLIMBING_X,
                y: _c.CHARACTER.MAX_VEL_CLIMBING_Y
            },
             ...
             */
            frictionUngrounded: {
                x: _c.CHARACTER.FRICTION_UNGROUNDED_X,
                    ...
                    // complex pathfinding
                        ...
                        if (this.path.length === 0) {
                            ...
                            if (this.path.length > 1 && !alwaysKeepFirst) {
                                ...
                                if ((node.x < x && nextNode.x > x) || (node.x > x && nextNode.x < x) || (node.y < y && nextNode.y > y) || (node.y > y && nextNode.y < y)) {
                    ...
                    // follow path
                        ...
                        if (!this.hasGravity) {
                            ...
                            if (!this.jumping) {
                                ...
                                if (!unsafe && (node.ungrounded && (!node.oneWay || node.oneWayFacing.y >= 0)) && avoidUngrounded && (this.grounded || this.climbing)) {
            ...
            climb: function() {
                ...
                if (this.canClimb && this.withinClimbables) {
                    ...
                    if (this.climbing !== true && ((this._climbingIntentUp && this.withinClimbablesAbove) || (this._climbingIntentDown && !this.grounded))) {
