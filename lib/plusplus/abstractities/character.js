			...
			placeholdAnims: function () {
				...
				if ( animPlaceholder ) {
					...
					if ( !anims.stairs ) {
						...
						anims.stairs = animPlaceholder;
						
					}
					
					if ( !anims.climb ) {
						
						anims.climb = animPlaceholder;
						
					}
					
					if ( !anims.jump ) {
						
						anims.jump = animPlaceholder;
						
					}
					
					if ( !anims.fall ) {
						
						anims.fall = animPlaceholder;
						
					}
					
					if ( !anims.run ) {
						
						anims.run = animPlaceholder;
                ...
                if (this.performance === _c.DYNAMIC) {
                    ...
                    if (_c.TOP_DOWN) {
						...
						if (this.facing.y !== 0) {
							...
							this.currentAnim.stop = !this.movingY;
							...
							this.currentAnim.stop = !this.movingX;
