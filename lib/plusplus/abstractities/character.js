ig.module(
    ...
    .defines(function () {
        ...
        ig.Character = ig.EntityExtended.extend(/**@lends ig.Character.prototype */{
             ...
             */
            size: { x: _c.ENTITY.SIZE_EFFECTIVE_X, y: _c.ENTITY.SIZE_EFFECTIVE_Y },
             ...
             */
            offset: { x: _c.ENTITY.SIZE_OFFSET_X, y: _c.ENTITY.SIZE_OFFSET_Y },

            /**
             * Max velocity while in air.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.MAX_VEL_UNGROUNDED_X
             * @see ig.CONFIG.ENTITY.MAX_VEL_UNGROUNDED_Y
             */
            maxVelUngrounded: _utv2.vector(_c.ENTITY.MAX_VEL_UNGROUNDED_X, _c.ENTITY.MAX_VEL_UNGROUNDED_Y),

            /**
             * Max velocity while on ground.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.MAX_VEL_GROUNDED_X
             * @see ig.CONFIG.ENTITY.MAX_VEL_GROUNDED_Y
             */
            maxVelGrounded: _utv2.vector(_c.ENTITY.MAX_VEL_GROUNDED_X, _c.ENTITY.MAX_VEL_GROUNDED_Y),

            /**
             * Max velocity while climbing.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.MAX_VEL_CLIMBING_X
             * @see ig.CONFIG.ENTITY.MAX_VEL_CLIMBING_Y
             */
            maxVelClimbing: _utv2.vector(_c.ENTITY.MAX_VEL_CLIMBING_X, _c.ENTITY.MAX_VEL_CLIMBING_Y),

            /**
             * Friction while in air.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.FRICTION_UNGROUNDED_X
             * @see ig.CONFIG.ENTITY.FRICTION_UNGROUNDED_Y
             */
            frictionUngrounded: _utv2.vector(_c.ENTITY.FRICTION_UNGROUNDED_X, _c.ENTITY.FRICTION_UNGROUNDED_Y),

            /**
             * Friction while on ground.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.FRICTION_GROUNDED_X
             * @see ig.CONFIG.ENTITY.FRICTION_GROUNDED_Y
             */
            frictionGrounded: _utv2.vector(_c.ENTITY.FRICTION_GROUNDED_X, _c.ENTITY.FRICTION_GROUNDED_Y),

            /**
             * Movement speed to be applied to acceleration.
             * @type Vector2
             * @see ig.CONFIG.ENTITY.SPEED_X
             * @see ig.CONFIG.ENTITY.SPEED_Y
             */
            speed: _utv2.vector(_c.ENTITY.SPEED_X, _c.ENTITY.SPEED_Y),
            ...
            /**
             * Slope angle range that character can stand on.
             * @type Vector2
             */
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.JUMP_STEPS
             * @example
             * // jump is short
             ...
             */
            jumpSteps: _c.ENTITY.JUMP_STEPS,

            /**
             * Speed modifier to apply on each jump step.
             * @type Number
             * @see ig.CONFIG.ENTITY.JUMP_FORCE
             * @example
             ...
             */
            jumpForce: _c.ENTITY.JUMP_FORCE,

            /**
             * Amount of acceleration control while in air.
             * @type Number
             * @see ig.CONFIG.ENTITY.JUMP_CONTROL
             * @example
             ...
             */
            jumpControl: _c.ENTITY.JUMP_CONTROL,
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.CLIMBING_CONTROL
             * @example
             ...
             */
            climbingControl: _c.ENTITY.CLIMBING_CONTROL,

            /**
             * Energy statistic, by default used in abilities.
             * @type Number
             * @see ig.CONFIG.ENTITY.ENERGY
             */
            energy: _c.ENTITY.ENERGY,
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.REGEN_RATE_HEALTH
             */
            regenRateHealth: _c.ENTITY.REGEN_RATE_HEALTH,
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.REGEN_RATE_ENERGY
             */
            regenRateEnergy: _c.ENTITY.REGEN_RATE_ENERGY,
             ...
             * @type Boolean
             * @see ig.CONFIG.ENTITY.EXPLODING_DAMAGE
             */
            explodingDamage: _c.ENTITY.EXPLODING_DAMAGE,
             ...
             */
            damageSettings: {
                spawnCountMax: _c.ENTITY.EXPLODING_DAMAGE_PARTICLE_COUNT,
                spawnSettings: {
             ...
             * <br>- explosions are created through an {@link ig.EntityExplosion}
             * @type Boolean
             * @see ig.CONFIG.ENTITY.EXPLODING_DEATH
             */
            explodingDeath: _c.ENTITY.EXPLODING_DEATH,
             ...
             */
            deathSettings: {
                spawnCountMax: _c.ENTITY.EXPLODING_DEATH_PARTICLE_COUNT,
                spawnSettings: {
                    animTileOffset: ig.EntityParticleColor.colorOffsets.WHITE
                }
            },
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.UNGROUNDED_FOR_THRESHOLD
             */
            ungroundedForThreshold: _c.ENTITY.UNGROUNDED_FOR_THRESHOLD,
             ...
             * @type Number
             * @see ig.CONFIG.ENTITY.MOVE_TO_STUCK_FOR_THRESHOLD
             */
            moveToStuckForThreshold: _c.ENTITY.MOVE_TO_STUCK_FOR_THRESHOLD,
             ...
             * <br>- used for actions such as climbing to keep character from falling automatically
             **/
            ...
            intersectWith: function (entity) {
                ...
                this.withinClimbables |= entity.climbable;
            ...
            /**
             * Enhanced handle movement trace for better slope behavior.
             * @see ig.Entity
             **/
            ...
            updateCleanup: function () {
                ...
                // reset collision properties when changed on next update

                if ( this.changed ) {

                    if ( this._dirtyCollisions ) {

                        this._dirtyCollisions = false;
                        this.withinClimbables = this.withinOneWay = 0;

                    }
                    else {

                        this._dirtyCollisions = true;
