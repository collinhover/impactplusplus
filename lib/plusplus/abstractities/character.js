                    ...
                    if ( simple ) {
                        ...
                        if ( this.path.length === 0 ) {
                            ...
                            if ( this.movingTo instanceof ig.EntityExtended ) {
                                ...
                                dx = ( this.movingTo.bounds.minX + this.movingTo.bounds.width * 0.5 ) - cx;
                                dy = ( this.movingTo.bounds.minY + this.movingTo.bounds.height * 0.5 ) - cy;

                            }
                            else {

                                dx = this.movingTo.x - cx;
                                dy = this.movingTo.y - cy;
                    ...
                    // follow path
                        ...
                        if ( !this.jumping ) {
                            ...
                            if ( minY <= nodeY && maxY >= nodeY ) {
                                ...
                                this.moveToUnsafe = !unsafeAllowed && !node.slopedNeighbor;
                            ...
                            // various checks for unsafe pathing

                            if ( !unsafeAllowed && this.grounded && node.ungrounded
                                && ( avoidUngrounded
            ...
            updateCurrentAnim: function () {
                ...
                if (this.performance === _c.DYNAMIC) {
                    ...
                    if (_c.TOP_DOWN) {
                        ...
                        if (this.movingX && !this.movingY && anims.moveX && this.currentAnim !== anims.moveX) {
                            ...
                            if (_c.FLIP_Y && anims.moveY && this.currentAnim !== anims.moveY) {

                                this.currentAnim = anims.moveY;

                            }
                            else if (anims.moveUp && anims.moveDown) {

                                if (this.vel.y > 0 && this.currentAnim !== anims.moveDown) {

                                    this.currentAnim = anims.moveDown;

                                }
                                else if(this.vel.y < 0 && this.currentAnim !== anims.moveUp) {
                        ...
                        if (this.climbing === true) {
                            ...
                            if ( this.withinStairs ) {
                                ...
                                if ( this.moving && anims.stairs ) {

                                    this.currentAnim = anims.stairs;
                            ...
                            if (this.jumping && anims.jump) {

                                if ( this.currentAnim !== anims.jump ) {

                                    this.currentAnim = anims.jump;
                            ...
                            else if (this.ungroundedFor > this.ungroundedForAndFallingThreshold && anims.fall) {

                                this.currentAnim = anims.fall;
                                return true;

                            }

                        }
                        else if (this.movingX && anims.run) {

                            this.currentAnim = anims.run;
                ...
                if ( anims.idle && this.currentAnim !== anims.idle ) {
