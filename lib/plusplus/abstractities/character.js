    ...
    .defines(function () {
        ...
        ig.Character = ig.EntityExtended.extend(/**@lends ig.Character.prototype */{
                ...
                if ( this.performance === _c.DYNAMIC ) {
                    ...
                    if ( this.movingTo ) {
                        ...
                        if ( this.canPathfind ) {
                            ...
                            this._dirtyPath = this.movingTo.changed || this.changed || this._dirtyPath;

                            if ( !this.movedTo || this._dirtyPath ) {
            ...
            findMoveToPath: function ( settings ) {
                ...
                if ( this.pathingTimer.delta() >= 0 && ( this.path.length === 0 || this._dirtyPath ) ) {
