                    ...
                    if ( simple ) {
                        ...
                        if ( dX !== 0 ) {
                            ...
                            if ( dX * dX < this.size.x * this.size.x * 0.25 ) {
                                ...
                                eX = this.pos.x + ( this.size.x * 0.5 > _pf.tilesize * 0.25 ? this.size.x - _pf.tilesize * 0.25 : this.size.x );
                                dX = 1;

                            }
                            else {

                                eX = this.pos.x + ( this.size.x * 0.5 > _pf.tilesize * 0.25 ? _pf.tilesize * 0.25 : 0 );
                                dX = -1;
                        ...
                        if ( dY !== 0 ) {
                            ...
                            if ( dY * dY < this.size.y * this.size.y * 0.25 ) {
                                ...
                                if ( dY > 0 ) {
                                    ...
                                    eY = this.pos.y + ( this.size.y * 0.5 > _pf.tilesize * 0.25 ? this.size.y - _pf.tilesize * 0.25 : this.size.y );
                                    dY = 1;

                                }
                                else {

                                    eY = this.pos.y + ( this.size.y * 0.5 > _pf.tilesize * 0.25 ? _pf.tilesize * 0.25 : 0);
                                    dY = -1;
