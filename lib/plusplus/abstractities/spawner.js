        ...
        ig.Spawner = ig.EntityTrigger.extend(/**@lends ig.Spawner.prototype */{
            ...
            spawnNext: function (entity) {
                ...
                if (this.spawnAtTarget && this.targetSequence.length > 0) {
                    ...
                    // spawn at next target
                        ...
                        this.spawnAt = this.targetSequence[ this._spawnedAtTargetIndex ];
                        this._spawnedAtTargetIndex = ( this._spawnedAtTargetIndex + 1 ) % this.targetSequence.length;
                ...
                else if (this.spawningEntity && this.spawnCount < this.spawnCountMax) {
            ...
            spawned: function (entity) {
                ...
                if (this.spawnAtRandomPosition ) {
                    ...
                    entity.pos.x = Math.random().map(0, 1, spawnAtMinX, spawnAtMaxX- width );
                    entity.pos.y = Math.random().map(0, 1, spawnAtMinY, spawnAtMaxY - height );
                ...
                if (this.spawnAndMoveTo) {
                    ...
                    entity.moveTo(this.targetSequence.length > 0 ? this.targetSequence : this.spawnAt, this.spawnAndMoveToSettings);
