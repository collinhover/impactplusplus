        ...
        ig.Spawner = ig.EntityTrigger.extend(/**@lends ig.Spawner.prototype */{
            ...
            unspawn: function (entity) {
                ...
                if (!entity._killed) {
                    ...
                    entity.kill( this.unspawnSilently );
            ...
            spawned: function (entity) {
                ...
                if (this.spawnAtRandomPosition ) {
                    ...
                    entity.pos.x = Math.random().map(0, 1, spawnAtMinX + halfWidth, spawnAtMaxX - halfWidth );
                    entity.pos.y = Math.random().map(0, 1, spawnAtMinY + halfHeight, spawnAtMaxY - halfHeight );
