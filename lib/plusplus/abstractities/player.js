ig.module(
    ...
    .defines(function () {
        ...
        ig.Player = ig.Character.extend(/**@lends ig.Player.prototype */{
             ...
             * <br>- automatically set to false on spawn and on death
             * @type Boolean
             * @default
             */
            controllable: true,
            ...
            /**
             * Initializes Player and starts input.
             * @override
             **/
            ...
            initProperties: function () {
                ...
                if (!ig.global.wm) {
                    ...
                    // setup camera to follow player after spawn and death

                    this.onAdded.add(ig.game.camera.follow, ig.game.camera);

                    // snap camera to player on first follow

                    if (ig.game.camera) {

                        ig.game.camera.follow(this, true);
                    ...
                    if (ig.input.state('hold')) {
                        ...
                        for (i = 0, il = inputPoints.length; i < il; i++) {
                            ...
                            if (!inputPoint.targetsDownStart.length) {
                                ...
                                var dx = inputPoint.worldX - this.getCenterX();
                                var dy = inputPoint.worldY - this.getCenterY();
