    ...
    .defines(function () {
        ...
        ig.AbilityShoot = ig.Ability.extend(/**@lends ig.AbilityShoot.prototype */{
            ...
            activate: function (settings) {
                ...
                var centerX = this.entity.pos.x + this.entity.size.x * 0.5;
                var centerY = this.entity.pos.y + this.entity.size.y * 0.5;
                ...
                if (settings) {
                    ...
                    if (!offsetX && !offsetY) {
                        ...
                        if (x && y) {
                            ...
                            offsetX = normalX * this.entity.size.x * 0.5;
                            offsetY = normalY * this.entity.size.y * 0.5;
