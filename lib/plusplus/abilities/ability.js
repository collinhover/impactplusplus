ig.module(
    ...
    .defines(function () {
        ...
        ig.Ability = ig.Class.extend(/**@lends ig.Ability.prototype */{
             ...
             * // there is a special case to target anything
             * ability.typeTargetable = 0;
            ...
            deactivateComplete: function (args) {
                ...
                if ( this.needsDeactivate ) {
                    ...
                    if ( this.deactivateCastSettings ) {
            ...
            isEntityTargetable: function (entity) {
                ...
                return ( ( !this.typeTargetable && !this.groupTargetable ) || ( ( entity.type & this.typeTargetable ) && !( this.entity.group & entity.group ) ) || ( entity.group & this.groupTargetable ) ) && ( ( this.canTargetOthers && this.entity !== entity ) || ( this.canTargetSelf && this.entity === entity ) );
