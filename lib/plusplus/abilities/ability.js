        ...
        ig.Ability = ig.Class.extend(/**@lends ig.Ability.prototype */{
            ...
            activateTry: function (args) {
                ...
                if (this.costActivate === 0) {
                    ...
                    if (this.assert(this.hasTarget(), ig.Ability.FAIL.TARGET)
                ...
                // has cost
                    ...
                    && this.assert(this.canPayCost(this.costActivate), ig.Ability.FAIL.COST)
                    && this.assert(this.closeEnough(), ig.Ability.FAIL.DISTANCE)) {
            ...
            isEntityTargetable: function (entity) {
                ...
                return ( !entity.fixed || this.canTargetFixed )
                        && ( !this.typeTargetable || ( entity.type & this.typeTargetable ) === this.typeTargetable && !( this.entity.group & entity.group ) )
                        && ( !this.groupTargetable || ( entity.group & this.groupTargetable ) === this.groupTargetable )
                        && ( ( this.canTargetOthers && this.entity !== entity ) || ( this.canTargetSelf && this.entity === entity ) );
