ig.module(
    ...
    .defines(function () {
        ...
        ig.Ability = ig.Class.extend(/**@lends ig.Ability.prototype */{
            ...
            /**
             * Cleans up ability by starting deactivate process.
             **/
            cleanup: function () {
            ...
            /**
             * Cleanup without any parameters, used when setting entity to execute passive abilities.
             **/
            ...
            effectStart: function (effect) {
                ...
                if (!effect.followTarget || this.entityTarget) {
                    ...
                    // remember current target in case it is dropped automatically

                    var entityTarget = this.entityTarget;

                    entity.onAdded.addOnce(function () {
                        ...
                        if (effect.followSettings) {
                            ...
                            if (effect.followTarget) {
                                ...
                                if (entityTarget) {
                                    ...
                                    entity.moveToEntity(entityTarget, effect.followSettings);
                        ...
                        // center entity by default
                            ...
                            entity.pos.x = this.entity.getCenterX() - entity.size.x * 0.5;
                            entity.pos.y = this.entity.getCenterY() - entity.size.y * 0.5;
            ...
            lookAt: function (target) {
                ...
                if (target && this.entity !== target && !target.fixed) {
                    ...
                    if (this.entity.getCenterX() > target.getCenterX()) {
