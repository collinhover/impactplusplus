    ...
    .defines(function () {
        ...
        ig.Ability = ig.Class.extend(/**@lends ig.Ability.prototype */{
            ...
            deactivate: function () {
                ...
                this._activated = this._activating = this._deactivating = false;
            ...
            lookAt: function (target) {
                ...
                if (target && this.entity !== target && !target.fixed) {
                    ...
                    if (_c.TOP_DOWN.ENABLED && _c.TOP_DOWN.FLIP_Y ) {
                        var entityCenterY;
                        var targetCenterY;
                    }
					...
					if ( this.entity.added ) {
						...
						if ( _c.TOP_DOWN.ENABLED && _c.TOP_DOWN.FLIP_Y ) {
                            entityCenterY = this.entity.bounds.minY + this.entity.bounds.height * 0.5;
                        }
                        ...
                        if ( _c.TOP_DOWN.ENABLED && _c.TOP_DOWN.FLIP_Y ) {
                            entityCenterY = this.entity.pos.y + this.entity.size.y * 0.5;
                        }
                    ...
                    this.entity.flip.x = entityCenterX > targetCenterX;

                    if (_c.TOP_DOWN.ENABLED && _c.TOP_DOWN.FLIP_Y ) {
                        this.entity.flip.y = entityCenterY > targetCenterY;
                    }
