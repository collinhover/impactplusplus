...
ig.Ability = ig.Hierarchy.extend( {
	...
	bind: function ( bindings ) {
		...
		_ut.arrayCautiousAddMulti( this.bindings, bindings );
	...
	unbind: function ( bindings ) {
		...
		_ut.arrayCautiousRemoveMulti( this.bindings, bindings );
	...
	bindCleanup: function ( bindings ) {
		...
		_ut.arrayCautiousAddMulti( this.bindingsCleanup, bindings );
	...
	unbindCleanup: function ( bindings ) {
		...
		_ut.arrayCautiousRemoveMulti( this.bindingsCleanup, bindings );
