            ...
            moveToEntityPosition: function (entity, settings) {
                ...
                if ( settings ) {
                    ...
                    if (offsetPct) {
                        ...
                        targetX += ( offsetX * entity.bounds.width * 0.5 + offsetX * this.bounds.width * 0.5 ) * ( entity.flip.x ? -1 : 1 );
                        targetY += ( offsetY * entity.bounds.height * 0.5 + offsetY * this.bounds.height * 0.5 ) * ( entity.flip.y ? -1 : 1 );
