        ...
        ig.Layer = ig.Class.extend(/**@lends ig.Layer.prototype */{
            ...
            checkEntities: function() {
                ...
                for( var i = 0, il = this.itemsChecking.length; i < il; i++ ) {
                    ...
                    var itemsChecked = {};
                    var minX = Math.floor( item.bounds.minX / cellSize );
                    var minY = Math.floor( item.bounds.minY / cellSize );
                    var maxX = Math.floor( item.bounds.maxX / cellSize ) + 1;
                    var maxY = Math.floor( item.bounds.maxY / cellSize ) + 1;
                                ...
                                for( var j = 0, jl = cell.length; j < jl; j++ ) {
                                    ...
                                    if( !itemsChecked[other.id] ) {
                                        ...
                                        if ( item.touches(other) ) {
                                            ...
                                            ig.Entity.checkPair( item, other );
