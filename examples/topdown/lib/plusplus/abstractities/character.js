    ...
    .defines(function () {
        ...
        ig.Character = ig.EntityExtended.extend(/**@lends ig.Character.prototype */{
            ...
            moveToUp: function (mod) {
                ...
                this.flip.y = _c.TOP_DOWN && _c.FLIP_Y;
            ...
            updateCurrentAnim: function () {
                ...
                if (this.performance === _c.DYNAMIC) {
                    ...
                    if (_c.TOP_DOWN) {
                        ...
                        if (this.movingX && !this.movingY && this.anims.moveX && this.currentAnim !== this.anims.moveX) {
                            ...
                            if (_c.FLIP_Y && this.anims.moveY && this.currentAnim !== this.anims.moveY) {
                ...
                else if (!this.anims.idle && !this.currentAnim.stop && !this.movingX && !this.movingY) {
